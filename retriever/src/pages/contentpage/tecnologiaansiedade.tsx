        ...
        <main className="bg-white flex min-h-screen flex-col items-center justify-between p-0">
            ...
            <div className="container mx-auto p-4 mt-40 flex">
                <div className="flex-1 space-y-20">
                    <h1 className="text-4xl font-bold mb-6 text-[#9A2AF3]">Tecnologia e Ansiedade</h1>
                    {posts.map((post) => (
                        <TopicCard
                            key={post._id}
                            _id={post._id}
...
export const getStaticProps: GetStaticProps = async () => {
    const posts = await getFilteredPosts(['Tecnologia e Ansiedade']); 
